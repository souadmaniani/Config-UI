...
aside nav a {
  padding: 0px 0px 37px 24px;
  text-decoration: none;
}
aside nav a:hover h5 {
  color: #1665D8;
}
aside nav a:hover rect {
  fill: #1665D8;
}
aside nav h5 {
  display: inline;
...
#authentification {
  ...
  background-color: #ffffff;
  border-radius: 4px;
  box-shadow: 0 1px 3px 0 rgba(63, 63, 68, 0.15), 0 0 0 0 rgba(63, 63, 68, 0.05);
}
@media (max-width: 768px) {
  #authentification {
    max-width: 768px;
...
#authentification h5, #authentification a {
  color: #9ea0a5;
}
#authentification h5.sign-up, #authentification a.sign-up {
  margin-bottom: 38px;
}
@media (max-width: 768px) {
  #authentification h5.sign-up, #authentification a.sign-up {
...
#authentification .image div.description {
  position: absolute;
  padding-left: 24px;
  bottom: 24px;
}
#authentification .image div.description .img-desc {
  display: flex;
  flex-direction: row;
}
#authentification .image div.description .img-desc img {
  width: 32px;
  height: 32px;
  object-fit: cover;
}
#authentification .image div.description .img-desc .title-desc {
  padding-left: 50px;
}
@media (max-width: 768px) {
  #authentification .image div.description .img-desc .title-desc {
...
#authentification .image div.description .img-desc .title-desc p {
  font-size: 14px;
...
.ui-container .dash-container .card .card-up {
  background-color: #ffffff;
  display: flex;
  flex-direction: row;
  justify-content: space-between;
}
.ui-container .dash-container .card h6 {
  font-family: "Roboto Bold";
  color: #66788a;
}
.ui-container .dash-container .card h1 {
  color: #212529;
  padding-bottom: 36px;
}
.ui-container .dash-container .card .card3-rect {
  position: relative;
  width: 100%;
  height: 4px;
  margin: 30px 8px 0 0;
...
.ui-container .dash-container .card .card3-rect .card3-rect-small {
  position: absolute;
  width: 38%;
  height: 100%;
  border-radius: 3px;
...
.ui-container .dash-container .card .group {
  display: flex;
  flex-direction: row;
  margin: 30px 8px 0 0;
}
.ui-container .dash-container .card .group svg {
  margin: 5px 8px 0 0;
}
.ui-container .dash-container .card .group h6 {
  margin-right: 8px;
  font-family: "Roboto Regular";
  color: #66788a;
}
.ui-container .dash-container .card .group .prc1 {
  color: #47b881;
  font-family: "Roboto Medium";
}
.ui-container .dash-container .card .group .prc2 {
  color: #bf0e08;
}
.ui-container .dash-container .card .oval {
  width: 64px;
  height: 64px;
  border-radius: 50%;
  padding: 19px 18px 19px 17px;
}
.ui-container .dash-container .card .oval1 {
  background-color: #ec4c47;
}
.ui-container .dash-container .card .oval2 {
  background-color: #47b881;
}
.ui-container .dash-container .card .oval3 {
  background-color: #1070ca;
}
.ui-container .dash-container .card4 {
  background-color: #3F51B5;
  margin-right: 0px;
}
.ui-container .dash-container .card4 h1 {
  color: #ffffff;
}
.ui-container .dash-container .card4 h6 {
  color: #ffffff;
}
.ui-container .dash-container .card4 .card-up {
  background-color: #3F51B5;
}
.ui-container .dash-container .card4 .group h6 {
  color: #ffffff;
}
